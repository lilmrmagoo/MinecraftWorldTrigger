...
public class MCreatorRaygustTrigger extends Elementsworld_trigger_craft.ModElement {
	...
	public void initElements() {
		elements.items.add(() -> new ItemSword(EnumHelper.addToolMaterial("RAYGUSTTRIGGER", 1, 300, 4f, 2f, 2)) {
			@Override
		...
		}.setUnlocalizedName("raygusttrigger").setRegistryName("raygusttrigger").setCreativeTab(MCreatorWorldTriggerTab.tab));
	}
